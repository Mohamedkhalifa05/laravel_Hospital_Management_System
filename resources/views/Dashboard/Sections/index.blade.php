                                        ...
                                        <table class="table text-md-nowrap" id="example2">
                                           ...
                                           @foreach($sections as $section)
                                               <tr>
                                                   ...
                                                   <td><a style="text-decoration:none" href="{{route('Sections.show',$section->id)}}">{{$section->name}}</a> </td>
                                                   {{-- <td>{{ \Str::limit($section->description, 50) }}</td> --}}
                                                   <td>{{ $section->created_at->diffForHumans() }}</td>
                                                   <td>
   <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"  data-toggle="modal" data-target="#edit{{ $section->id }}">
